...
> **A Etapa 1.4 abaixo foi executada, treze anos de calendário depois de ter sido especificada, e o teste que ela viabiliza não encontra contaminação.** Achado mais grave do segundo council review sobre `texto_anpec/paper_anpec.tex` (4 críticos; relatório em `relatorio/council_2026-08-10.md`), **aberto e fechado no mesmo dia**. Código: `R/data_download/fomc_dates.R`, `R/instrument/event_tests.R`, `script/fomc_coincidence.R` → `output/instrument/fomc_coincidence.{csv,md}` + `fomc_coincidence_days.csv` + overlay; leitura em `relatorio/working-notes/2026-08-10_coincidencia_fomc.md`. **Nada aqui mudou** — `DEFAULT_VARIANT`, vértice, esquema de agregação e a cadeia de `build_variants.R` seguem intocados, e as 8 colunas `z_*` saíram **bit-idênticas** depois de repopular a flag.
...
**Executada em 2026-08-10** (`R/data_download/fomc_dates.R` → `data/fomc_dates.csv`).
...
> metodológico: `relatorio/working-notes/2026-08-10_bandas_anderson_rubin.md`.
