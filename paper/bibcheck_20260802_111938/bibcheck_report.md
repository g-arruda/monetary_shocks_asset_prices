...
`corrected.bib` was compiled against `paper_anpec.tex` in a scratch copy: **25 entries used, 0 BibTeX warnings, 0 errors, 0 undefined citations, 25 `\bibitem`s** — same count as the current file. Nothing in `paper/` was modified.
