...
A especificação de produção é $(r, q, p) = (4, 4, 4)$. O IC2 de \cite{bai-ng}, na versão BLL padronizada de \cite{barigozzi2016non}, seleciona $r=4$ na amostra completa. Mantemos $q=4$ por decisão explícita; Amengual--Watson BLL condicionado a $r=4,p=4$ seleciona $q=2$, resultado reportado mas não usado para governar a dimensão. O AIC seleciona $p=4$ (6,826217) na amostra comum de 141 observações com constante e tendência; a tendência pertence somente ao critério e o VAR fatorial estimado mantém intercepto.
...
Seguimos \cite{montielolea} para avaliar a relevância do instrumento. A estatística de Wald no espaço dos fatores, $\xi_{mp}$, é $6{,}38$ na amostra completa e $7{,}19$ na janela pré-COVID, enquanto o primeiro estágio robusto, $F^{rob}_{mp}$, vale $14{,}16$ e $12{,}71$, respectivamente. Ambas as estatísticas projetam o instrumento na combinação das inovações fatoriais que determina a normalização no DI de seis meses.
