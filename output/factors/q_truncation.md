...
Wald conjunto de z contra as direções `q+1..5` dos autovetores de `cov(u)` da célula `q = 5`, χ²(5 − q), nível 5%. Com `q` choques e instrumento válido, a ortogonalidade vale.
