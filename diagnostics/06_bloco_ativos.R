...
cat("  Estado do dado:\n")
cat("   - data/raw/raw_data.csv e o painel processado nao contem break-even.\n")
cat(sprintf("     O painel processado tem %d series; as tres antigas colunas 100%% NA\n",
            ncol(PANEL)))
cat("     e o downloader ANBIMA sem cobertura foram removidos do fluxo ativo.\n")
