...
O que reprovou foi a pré-condição, em duas frentes (`registro/historico_decisoes.md:185-186`):
...
*Fontes: `output/nongaussian/{gate.md,results.md,gmr_cell.rds}`, `output/nongaussian/corroboration_*.csv` (gerados por `script/nongaussian_corroboration.R`), `registro/historico_decisoes.md` §0 e §1, `registro/pendencias.md:731-758`, `output/instrument/mosw_strength_grid.csv`, e `git show fc0ef58^:output/irf/spec_sweep_irf_long.csv` para as IRFs de het arquivadas.*
