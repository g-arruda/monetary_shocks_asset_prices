...
- `data/processed/instrument.csv` — single-column instrument consumed by both estimation scripts; overwritten by `instrument.R` from `DEFAULT_VARIANT` (current default: `z_jk_purif` since 2026-05-08 — the F (y6m AR) = 55.98 of `z_het_jk_3var` masked a severely weak factor-space F ≈ 2.7).
