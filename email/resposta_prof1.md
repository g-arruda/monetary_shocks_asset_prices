...
Resp: Não sei se é viável e quão complicado a implementação, mas há pelo menos duas referências que tratam desse ponto: 
...
----
Em resumo, Gabriel, sobre o item 2, recomendo que você pelo menos leia (ao menos dê uma olhada) os dois papers antes de fechar a porta, já que o esforço de reenquadrar o que já existe é baixo; item 4, ao menos escreva o parágrafo, já que o trabalho pesado já foi feito; item 3, é a prioridade de maior retorno, porque você já tem o resultado bruto, só falta a decomposição cambial (rápida, dado que é série pública do BCB) para transformar em evidência defensável.