...
> (i) O CDS 5a diário **existe** (`data/raw/CDS 5y.xlsx`, Bloomberg), então a
...
(`pareceres/council_2026-07-31.md`). Os três críticos convergiram por ângulos
...
parágrafo abaixo fica só por procedência: `data/raw/CDS 5y.xlsx` existe, o script o
lê como entrada **obrigatória** (não há mais detecção automática de
`data/raw/investing/cds5y_daily.csv`, que nunca chegou a existir), e o veredito é o
...
> americano). O script detecta `data/raw/investing/cds5y_daily.csv` automaticamente se
> o arquivo aparecer.
...
*(2026-08-09: escrita como §5.2 de `paper/paper_anpec.tex`, `sec:confound`,
