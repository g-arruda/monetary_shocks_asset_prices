...
> [`historico_decisoes.md` §2.4](../../registro/historico_decisoes.md) e no
...
> Objeção 1 do `pareceres/council_2026-08-10.md`. Irmã da rodada soberana:
...
ponteiro para o downloader, e `script/run_all.R` declara `data/raw/fomc_dates.csv`
