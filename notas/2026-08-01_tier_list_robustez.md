...
> comentados dentro do §4), `paper/paper_anpec.tex`, `registro/pendencias.md`,
...
> `paper/paper_anpec.tex` com **as duas primeiras subseções do §7 abaixo**,
...
- `tex/main.tex` — `\section{Robustez}` **inteira comentada** (447-500), com as
  ...
  369, 441, 445).
- `paper/paper_anpec.tex` — **não tem seção de robustez nenhuma**. Vai de
...
**escrito em 2026-08-09** como §5.2 de `paper/paper_anpec.tex`
...
em `sec:exogeneidade`, §5.1 de `paper/paper_anpec.tex`
...
escrita em `paper/` traz o +3,43% e a frase que o desarma no mesmo lugar,
...
direto em `paper/paper_anpec.tex`, e o bloqueio descrito aqui (a §5
