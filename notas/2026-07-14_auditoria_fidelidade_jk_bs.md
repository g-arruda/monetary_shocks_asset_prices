...
> Versão mais completa em `pareceres/2026-07-15_auditoria_fidelidade_instrumento.md`.
...
Novos insumos (`R/data_download/focus_fred.R`): `data/processed/focus_daily.csv` (mediana Focus IPCA-12m suavizada + Selic fim-do-ano-seguinte, diário, 3.412 dias, 0 NA) e `data/raw/fred_dgs2.csv` (Treasury 2y, 3.395 dias).
